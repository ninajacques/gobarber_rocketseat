...
appointmentsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, date, provider_id, parsedDate, createAppointment, appointment;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, date = _a.date, provider_id = _a.provider_id;
                parsedDate = date_fns_1.parseISO(date);
                createAppointment = new CreateAppointmentService_1.default();
                return [4 /*yield*/, createAppointment.execute({ date: parsedDate, provider_id: provider_id })];
            case 1:
                appointment = _b.sent();
